...
// 2019-06-09T20:43:28-05:00
// using the command
// $ go-mockgen -f github.com/go-nacelle/config -i TagModifier -o tag_modifier.go
...
// MockTagModifier is a mock impelementation of the TagModifier interface
...
func (m *MockTagModifier) AlterFieldTag(v0 reflect.StructField, v1 *structtag.Tags) error {
	...
	m.AlterFieldTagFunc.history = append(m.AlterFieldTagFunc.history, TagModifierAlterFieldTagFuncCall{v0, v1, r0})
	return r0
}
...
// AlterFieldTag method of the parent MockTagModifier instance inovkes the
