...
// 2020-04-01T15:32:17-05:00
// using the command
// $ go-mockgen -f github.com/go-nacelle/config -i FileSystem -o fs_mock_test.go

package config

import "sync"

// MockFileSystem is a mock impelementation of the FileSystem interface
...
// Exists method of the parent MockFileSystem instance inovkes the hook at
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// Glob method of the parent MockFileSystem instance inovkes the hook at the
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// ListFiles method of the parent MockFileSystem instance inovkes the hook
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// ReadFile method of the parent MockFileSystem instance inovkes the hook at
// the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
