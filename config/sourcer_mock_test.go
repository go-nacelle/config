...
// 2019-06-04T17:45:31-05:00
// using the command
// $ go-mockgen -f github.com/go-nacelle/config/sourcer -i Sourcer -o sourcer_mock_test.go

package config

import sourcer "github.com/go-nacelle/config/sourcer"

// MockSourcer is a mock impelementation of the Sourcer interface (from the
// package github.com/go-nacelle/config/sourcer) used for unit testing.
