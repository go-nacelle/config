...
// 2018-11-19T11:25:23-06:00
// using the command
// $ go-mockgen -f github.com/efritz/zubrin/config -i Config -o mock_config_test.go

package logging

import (
	config "github.com/efritz/zubrin/config"
	tags "github.com/efritz/zubrin/tags"
)

// MockConfig is a mock impelementation of the Config interface (from the
// package github.com/efritz/zubrin/config) used for unit testing.
