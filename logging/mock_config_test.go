...
// 2019-06-04T17:45:32-05:00
// using the command
// $ go-mockgen -f github.com/go-nacelle/config/config -i Config -o mock_config_test.go
...
// package github.com/go-nacelle/config/config) used for unit testing.
